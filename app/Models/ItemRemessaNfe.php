...
class ItemRemessaNfe extends Model
{
   ...
   /* protected $table = 'item_remessa_nves'; // tabela correta aqui

    protected $fillable = [
        'remessa_id', 'produto_id', 'quantidade', 'valor_unitario', 'sub_total','codBarras',
    ...
    public function produto(){
       ...
       // return $this->belongsTo(ProdutoOutraConexao::class, 'produto_id');
