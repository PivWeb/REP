...
use App\Http\Controllers\CartaCorrecaoController;
Route::get('/carta-correcao', [CartaCorrecaoController::class, 'form'])->name('carta-correcao.form');
Route::post('/carta-correcao', [CartaCorrecaoController::class, 'emitir'])->name('carta-correcao.enviar');
Route::get('/carta-correcao/listar', [CartaCorrecaoController::class, 'listar'])->name('carta-correcao.listar');
Route::get('/carta-correcao/download/{id}', [CartaCorrecaoController::class, 'download'])->name('carta-correcao.download');
...
Route::get('/nfe_remessa/buscar-clientes', [App\Http\Controllers\NfeRemessaController::class, 'buscarClientes'])->name('nfe_remessa.buscar_clientes');

Route::get('/nfe_remessa/clientes/{id}/pedidos-recentes', [App\Http\Controllers\NfeRemessaController::class, 'pedidosRecentes'])->name('nfe_remessa.clientes.pedidos_recentes');

Route::get('/nfe_remessa/pedidos-recentes/{clienteId}', [NfeRemessaController::class, 'pedidosRecentes']);

//Route::get('/clientes/{id}/pedidos-recentes', [App\Http\Controllers\ClienteController::class, 'pedidosRecentes'])->name('clientes.pedidos_recentes');

Route::get('/nfe_remessa/pedido/{id}/itens', [NfeRemessaController::class, 'itensPedido']);
//Route::get('/nfe_remessa/pedido/{id}/itens', [NfeRemessaController::class, 'itensPedido']);
...
Route::group(['prefix' => '/payment', 'middleware' => 'verificaEmpresa'], function () {
    Route::get('/', 'PagamentoController@index')->name('payment.index');
    Route::post('/payment-pix', 'PagamentoController@paymentPix')->name('payment.pix');
    Route::post('/payment-card', 'PagamentoController@paymentCard')->name('payment.card');

    Route::get('/finish', 'PagamentoController@finish')->name('payment.finish');
    Route::post('/setPlano', 'PagamentoController@setPlano');
    Route::get('/{code}', 'PagamentoController@detalhesPagamento')->name('payment.detail');
    Route::get('/consulta/{code}', 'PagamentoController@consultaPagamento');
});
