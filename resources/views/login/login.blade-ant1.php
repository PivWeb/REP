...
<body>
            ...
            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                <div class="col mx-auto">
                    <div class="mb-4 text-center">
                        <img src="logos/slym.jpg" style="width: 200px; height: 200px;" alt="Piv-Web Sistemas">
                    </div>
                    <div class="card">
                        <div class="card-body">
    ...
    <img src="assets/images/img15.jpg" style="max-width: 100%; height: auto; display: block;">
</div>
