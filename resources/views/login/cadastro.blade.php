            ...
            <div class="card mt-5">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="card-body">
                            <center><img width="250" src="logos/slym.jpg"></center>
                    ...
                    <div class="col-12 col-md-5 d-none d-sm-block" style="background-color: #FFF;">
                        <img src="/assets/images/img123.jpg" class="card" style="margin-left:80px; margin-top:30px ;height: 710px; width: 437px; position: absolute" alt="">
                    </div>
                </div>
            </div>
        </div>
