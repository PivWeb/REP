@extends('default.layout',['title' => 'Lista de NFe'])
@section('content')
<div class="page-content">
    <div class="card ">
        <div class="card-body p-4">
            ...
            <div class="col">
                <h6 class="mb-0 text-uppercase">Pesquisar NFe</h6>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-5 text-left mt-3">
                        ...
                        <a id="clear-filter" class="btn btn-danger" href="{{ route('nferemessa.index') }}"><i class="bx bx-eraser"></i> Limpar</a>
                    </div>
                </div>
                {!!Form::close()!!}
                <hr />
                <h6>Lista de NFe Emitidas</h6>
                {{-- <p>Registros: {{ $data->total() }}</p> --}}

                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('nferemessa.create')}}" type="button" class="btn btn-success">
                            <i class="bx bx-plus"></i> Nova NFe
                        </a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive tbl-400">
                            <table class="table mb-0 table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" value="{{$item->id}}" data-email="{{$item->email}}" class="checkbox" name="" data-status="{{$item->estado_emissao}}" data-numero_nfe="{{$item->numero_nfe}}">
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" style="z-index: 999">
                                                    <form action="{{ route('nferemessa.destroy', $item->id) }}" method="post" id="form-{{$item->id}}">
                                                        @method('delete')
                                                        @csrf
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('nferemessa.edit', $item->id) }}">Editar</a>
                                                        </li>
                                                        ...
                                                        @endif
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('nferemessa.xml-temp', $item->id) }}">XML temporário</a>
                                                        </li>

                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('nferemessa.state-fiscal', $item->id) }}">Alterar estado fiscal</a>
                                                        </li>
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-2">
                             ...
                             <!-- Botão de Carta de Correção -->
    <div class="col-md-2">
        <a href="#" class="btn btn-outline-primary spinner-white spinner-right" style="width: 100%" disabled>
            Carta de Correção
        </a>
    </div>
                            ...
                            <div class="col-md-2">
                                <button type="button" data-href="{{ route('nferemessa.danfe-temp') }}" class="btn btn-dark spinner-white btn-action spinner-right px-1" style="width: 100%" id="btn-danfe-temp">Danfe Temporária</button>
                            </div>
                            <div class="col-md-2">
                                <button id="btn-enviar-email" type="button" data-bs-toggle="modal" data-bs-target="#modal-emailRemessa" class="btn btn-primary spinner-white btn-action spinner-right" style="width: 100%">Enviar E-mail</button>
                            </div>
...
@include('modals._emailRemessa', ['not_submit' => true])
