            ...
            <header>
                <div class="topbar d-flex align-items-center">
                    <nav class="navbar navbar-expand">
                        ...
                        <div class="top-menu">
                            <!--a class="btn btn-primary btn-sm px-3 " href="{{ route('frenteCaixa.index') }}" ><i class="bx bx-cart" disabled> </i> PDV</a-->
...
<footer class="page-footer">
    <p class="mb-0">
        ...
        @if($ultimoAcesso != null)
        <strong class="text-primary">Último acesso: {{ \Carbon\Carbon::parse($ultimoAcesso->created_at)->format('d/m/Y H:i:s') }}</strong>
        @endif
    </p>
</footer>
</div>
