<div class="modal fade" id="modal-finalizar_venda" aria-modal="true" role="dialog" style="overflow:scroll;" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-lg-6 col-12">
                    <button @if($config->arquivo != null) @endif class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#modal-cpf_nota" style="height: 50px; width: 100%">
    ...
    <button type="submit" 
            ...
            @if($atalhos == null || $atalhos->finalizar_nao_fiscal == '') disabled @endif>
        
        <i class="bx bx-file-blank"></i> Contigência
